INSERT INTO users (id, name, email, password, created, modified, last_login, is_active) VALUES
          ...
          (RANDOM_UUID(), 'Lucia', 'lucia@example.com', '$2a$10$.NCgBTN2uGvypuXFBAhhOOom//.rzWnD8Ivo9AgdlhbQseai04lsC', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, true);
